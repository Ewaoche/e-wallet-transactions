...
$sql = "SELECT amount FROM ecom_customers_wallets WHERE email = '$email'";
 $query =  mysqli_query($conn, $sql);
 $fetch = mysqli_fetch_array($query);
 if($fetch){
  $withdrable_money =  $fetch['amount'];
//   echo $withdrable_money;
 }
        ...
        <ul id="header-actions" class="clearfix">
            ...
            <li class="list-box user-admin dropdown">
                <div class="admin-details">
                    ...
                    <div class="name"><strong><?php  echo $_SESSION['username'] ?></strong></div>
...
<li class="dropdown pull-right"><a href="exit.php"><i class="icon-close"></i>Logout</a></li>
...
<div class="top-bar clearfix">
    <div class="row gutter">
       ...
       <ul class="right-stats" id="mini-nav-right">
           <li class=""><a href="fund_transaction.php" class="btn btn-success text-center"><i class="icon-close"></i> Fund my Wallet </a></li>
           <li class=""><a href="transfer_transaction.php" class="btn btn-success text-center"><i class="icon-close"></i> Transfer Money </a></li>
       </ul>
       </div>
